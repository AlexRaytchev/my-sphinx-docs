...
from pyOptiShared.Simulator import Mesh,PML_Params
import gdstk
import numpy as np
...
pml=PML_Params()
#pml.SetMinX(thickness=0.6,profile=2,kappa=1,sigma=1.0,alpha=0.00)


mode_solver.SetBoundaries(min_x = "pml", max_x = "pml",
                        min_y = "pml", max_y = "pml",params=pml)
...
results.PlotMode(field='Hy',lam=1.55) # Fundamental Mode Profile
