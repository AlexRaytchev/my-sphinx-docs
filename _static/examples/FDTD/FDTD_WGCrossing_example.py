...
fdtd_solver.SetExcitation(profile="gaussian-pw", lcenter=1.55, lmin=1.5, lmax=1.6, npts=21, mode_indices=0,
...
fdtd_solver.AddDFTMonitor(mon_type="2d-x-normal", x0=0.0, name="MyDFTMonitor2",
                          lmin=1.5, lmax=1.6,npts=12,
                          
                          save_hx=True)


fdtd_solver.AddDFTMonitor(mon_type="2d-y-normal", y0=0.0, name="MyDFTMonitor3",
                          lmin=1.5, lmax=1.6,npts=12,
                         
                          save_hx=True)
fdtd_solver.SetBoundaries()
fdtd_solver.SetSimSettings(sim_time=1500, space_step=0.050, subpixel_level=2, results_path=r"results",device_name='etchedCrossing',
...
results.PlotDFTMonitor('MyDFTMonitor2',field='Hx')
results.PlotDFTMonitor('MyDFTMonitor3',field='Hx')
