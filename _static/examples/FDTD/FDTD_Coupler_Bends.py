...
fdtd_solver.AddDFTMonitor(mon_type="2d-z-normal", z0=0.11, name="MyDFTMonitor1",
                                                      ...
                                                      save_hz=True,
                                                      save_hx=True)
fdtd_solver.SetSimSettings(sim_time=tfinal, space_step=0.04, subpixel_level=2, results_path=r"results",device_name='coupler_withbends',
...
plt.plot(lam,np.abs(s41),label='mag_s41')
